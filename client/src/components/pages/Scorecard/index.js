...
class playersList extends React.Component
{
  ...
  <label>
    ...
    onSubmit={(player1Text) => this.setState({text})}
  ...
  <label>
    ...
    onSubmit={(player2Text) => this.setState({text})}
    onChange = {this.handleChange}
    />
  </label>
  <br></br>
  <label>
    ...
    onSubmit={(player3Text) => this.setState({text})}
    onChange = {this.handleChange}
    />
  </label>
  <br></br>
  <label>
    ...
    onSubmit={(player4Text) => this.setState({text})}
    onChange = {this.handleChange}
    />
  </label>
  <br></br>
